      ...
      mysqli_stmt_store_result($stmt);
        ...
        if(mysqli_stmt_num_rows($stmt) >= 1){
            ...
            while (mysqli_stmt_fetch($stmt)) {
              ...
              $msg1 = "Kære ". $name1 ."\r\n"."Din vagt den " .$dag ."/".$month."-".$year." klokken ".$tid." er blevet overtaget af " . $name2 .".";
              $subject1 = "Vagtbytte den ".$dag ."/".$month."-".$year." accepteret.";

              $msg2 = "Kære ".$name2 ."\r\n"."Du har overtaget vagten den " .$dag ."/".$month."-".$year." klokken ".$tid." fra " .$name1.".";
              $subject2 = "Vagtbytte den ".$dag ."/".$month."-".$year." accepteret.";
